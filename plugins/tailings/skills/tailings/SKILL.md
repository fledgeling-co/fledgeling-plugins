...
Treat a nonempty model outside the known family vocabulary identically, for both the running model
and the requested lane model; it is unknown evidence, not proof of independence.
