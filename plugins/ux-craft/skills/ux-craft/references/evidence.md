...
## Flow-shape variety — added 2026-08-31

`references/flow-shape-variety.md` is practitioner procedure, not a behavioural law. It exists because generated journeys converge on the same skeleton (hero CTA, three features, three-step how-it-works, FAQ) even when each step is usable. No citation in this file claims that varying the skeleton raises conversion; NN8 (convention as prediction) still wins for checkout, auth and payment. The file's load-bearing rule is the one already measured for pages in design-craft `ai-slop-check.md` §17: a section list that is the brief's own headings in the brief's own order is a structural tell. Here the equivalent is a step list that is the category default with the nouns swapped.

## Persuade conversion — added 2026-08-31

`references/persuade-conversion.md` is a scoped import from [ai-design-skills landing-page-design](https://github.com/elayadesign/ai-design-skills/blob/1c1e97cb9878e236552c772092dda7adcdddbcb2/skills/landing-page-design/SKILL.md), snapshot `1c1e97cb`, accessed 2026-08-31. It imports the one-offer / one-audience / one-action contract, proof placement, CTA visibility, and objection handling. Its font whitelist, hyphen ban, and universal section template are deliberately excluded. This is conversion procedure, not evidence that any particular arrangement increases conversion.
