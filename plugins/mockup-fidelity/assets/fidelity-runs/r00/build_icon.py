...
def svg() -> str:
  ...
  <defs>
    ...
    <linearGradient id="gel" x1="{BX}" y1="{BY}" x2="{BX + MW}" y2="{BY + MH}"
    ...
    <linearGradient id="transmit" x1="{BX}" y1="{BY}" x2="{BX + MW * .7}" y2="{BY + MH}"
                    gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="{RIM}" stop-opacity=".19"/>
      <stop offset=".55" stop-color="{RIM}" stop-opacity=".05"/>
      <stop offset="1" stop-color="{RIM}" stop-opacity=".12"/>
    </linearGradient>
    ...
    <g id="mid">
      ...
      <g mask="url(#exposed)">
        ...
        <g filter="url(#edgeSoft)">
          {build} fill="none" stroke="{ACCENT_CORE}" stroke-width="11" opacity=".62"/>
        </g>
    ...
    <g id="highlight">
      ...
      <g clip-path="url(#buildClip)">
        ...
        {rr(BX + 7, BY + 7, MW - 14, MH - 14, R - 7)} fill="none"
              stroke="url(#transmit)" stroke-width="13"/>
      </g>
