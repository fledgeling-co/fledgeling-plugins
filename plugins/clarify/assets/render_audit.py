...
RASTERS = [("icon-engineC-9153f5.png", "icon-engineC-9153f5-masked.png"),
           ("icon-engineC-4c230c-2.png", "icon-engineC-4c230c-2-masked.png")]

# takes: id -> (source, kind)
TAKES = {
    "a": ("icon.svg", "svg"),
    "a0": ("icon-r00-baseline.svg", "svg"),
    "b": ("icon-engineB-arrow-954e4a.svg", "svg"),
    "c1": ("icon-engineC-9153f5-masked.png", "png"),
    "c2": ("icon-engineC-4c230c-2-masked.png", "png"),
}
