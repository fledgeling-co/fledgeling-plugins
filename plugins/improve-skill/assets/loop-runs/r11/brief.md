...
This is round r11 on this fixture. The round's edit class is detail.
...
Do not read these files; they are generated output, they are large enough to exhaust the context window, and nothing in this round needs their text: `icon.svg` (314KB). Judge the artwork from its PNG renders and edit the build script. If you must confirm a fragment, grep it or read a bounded byte range.
</fixture>
...
|---:|---:|---:|---:|---:|
| 1024 | 0.4584 | 0.1274 | 0.6185 | 0.1574 |
| 256 | 0.4725 | 0.1235 | 0.5838 | 0.2474 |
| 128 | 0.5163 | 0.1211 | 0.5612 | 0.4453 |
| 32 | 0.7865 | 0.1169 | 0.6065 | 0.8938 |
