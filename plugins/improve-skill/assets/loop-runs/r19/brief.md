...
This is round r19 on this fixture. The round's edit class is small-size repair.
...
- `/Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r18/` — the baseline this round is measured against: `score.json`,
...
|---:|---:|---:|---:|---:|
| 1024 | 0.5266 | 0.1149 | 0.6237 | 0.3518 |
| 256 | 0.4902 | 0.1109 | 0.5858 | 0.2446 |
| 128 | 0.5403 | 0.1086 | 0.5639 | 0.4672 |
| 32 | 0.8008 | 0.1055 | 0.6038 | 0.9171 |
| 16 | 0.8408 | 0.1025 | 0.6332 | 0.9940 |
...
an absolute floor at 6% below the baseline's:
  ...
  32px: your master 0.582, the reference 0.449, floor 0.547
  16px: your master 0.575, the reference 0.427, floor 0.540
...
Run the instrument as you go:
    ...
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py score --candidate icon.svg --reference icon-engineC-f5665d-2.png --outdir /Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r19 --label "r19 small-size repair"
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py gate --candidate /Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r19/score.json --baseline /Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r18/score.json
