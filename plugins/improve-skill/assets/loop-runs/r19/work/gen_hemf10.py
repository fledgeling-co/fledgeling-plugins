...
{SHAVING_GRAD}  <!-- ROUND 7: re-centred toward the key and deepened. C2's corners measure TL 0.869,
  ...
  <linearGradient id="hemFall" x1="0" y1="0" x2="{BLADE_LEN}" y2="0"
                  gradientUnits="userSpaceOnUse" gradientTransform="{MATRIX}">
    <stop offset="0" stop-color="#332A1E" stop-opacity="0.00"/>
    <stop offset="0.55" stop-color="#332A1E" stop-opacity="0.55"/>
    <stop offset="1" stop-color="#332A1E" stop-opacity="0.62"/>
  </linearGradient>
...
<g clip-path="url(#tileMask)">
  ...
  <g id="mid">
    ...
    <g clip-path="url(#roughSide)" filter="url(#hemBlur)">
      <path d="{open_poly(CHAIN_UPPER)}" fill="none" stroke="url(#hemFall)"
