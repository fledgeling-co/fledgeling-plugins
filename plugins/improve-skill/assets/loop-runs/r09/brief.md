...
This is round r09 on this fixture. The round's edit class is material.
...
- `/Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r08/` — the baseline this round is measured against: `score.json`,
...
Do not read these files; they are generated output, they are large enough to exhaust the context window, and nothing in this round needs their text: `icon.svg` (306KB). Judge the artwork from its PNG renders and edit the build script. If you must confirm a fragment, grep it or read a bounded byte range.
</fixture>
...
|---:|---:|---:|---:|---:|
| 1024 | 0.4539 | 0.1298 | 0.6674 | 0.0746 |
| 256 | 0.4728 | 0.1270 | 0.5942 | 0.2518 |
| 128 | 0.5124 | 0.1250 | 0.5619 | 0.4507 |
| 32 | 0.7877 | 0.1212 | 0.6051 | 0.9056 |
| 16 | 0.8343 | 0.1171 | 0.6338 | 1.0000 |
...
an absolute floor at 6% below the baseline's:
  ...
  32px: your master 0.624, the reference 0.449, floor 0.586
  16px: your master 0.608, the reference 0.427, floor 0.572
...
<task>
Make ONE class of edit: material. In scope: gradient stops and ramps, per-face shading separation, opacity, blur radii, highlight and shadow shapes, contact shadows, ambient occlusion, rim light. Out of scope: silhouette, footprint, object scale, composition.
...
Run the instrument as you go:
    ...
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py score --candidate icon.svg --reference icon-engineC-f5665d-2.png --outdir /Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r09 --label "r09 material"
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py gate --candidate /Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r09/score.json --baseline /Users/lukerhodes/Dev/fledgeling-plugins/plugins/improve-skill/assets/loop-runs/r08/score.json
...
- Deliver what was asked, at the scope intended: one material round on this
