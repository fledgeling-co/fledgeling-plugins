...
Combined with `better-loop`, which ran the same protocol: **42/43 assertions
...
3. **`better-loop` step 4 pointed at a script that does not exist** (`arm.sh`).
...
A deep review of the ten scripts (`code-review-goal-better-loop.md`) then found
