...
Each round's `brief.md` carries the measurement it was built on. r04's is the one to
read first: the emission gap the user spotted turned out to be three separate faults,
