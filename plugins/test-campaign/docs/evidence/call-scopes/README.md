...
fingerprint. Reports retain the raw mutating-body denominator and count scoped calls by classification.
...
arbitrary non-caller body. The generated catalogue version is kept at 0.16.2 with both manifests.
