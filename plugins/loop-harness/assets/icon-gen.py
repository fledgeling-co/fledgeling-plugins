#!/usr/bin/env python3
"""Icon generator for goal-harness and loop-harness.

One metaphor, shared device: a bearing needle on a porcelain dial.
  goal-harness — the needle locked on a mark, held by a ratchet pawl.
  loop-harness — the same needle circling a fixed watch-point, one tick per pass.
