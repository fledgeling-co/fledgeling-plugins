...
This is round r03 on this fixture. The round's edit class is detail.
...
- `/Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r02/` — the baseline this round is measured against: `score.json`,
...
|---:|---:|---:|---:|---:|
| 1024 | 0.5082 | 0.1198 | 0.8011 | 0.0219 |
| 256 | 0.4193 | 0.1193 | 0.5419 | 0.0783 |
| 128 | 0.3905 | 0.1189 | 0.3607 | 0.2508 |
| 32 | 0.6322 | 0.1171 | 0.1855 | 0.7539 |
| 16 | 0.7244 | 0.1160 | 0.2124 | 0.9851 |
...
Run the instrument as you go:
    ...
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py score --candidate icon.svg --reference icon-engineC-fe8278-2.png --outdir /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r03 --label "r03 detail"
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py gate --candidate /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r03/score.json --baseline /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r02/score.json
