...
This is round r04 on this fixture. The round's edit class is detail.
...
- `/Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r03/` — the baseline this round is measured against: `score.json`,
...
|---:|---:|---:|---:|---:|
| 1024 | 0.5056 | 0.1197 | 0.8022 | 0.0092 |
| 256 | 0.4178 | 0.1191 | 0.5432 | 0.0690 |
| 128 | 0.3907 | 0.1188 | 0.3627 | 0.2478 |
| 32 | 0.6311 | 0.1171 | 0.1865 | 0.7502 |
| 16 | 0.7243 | 0.1160 | 0.2121 | 0.9851 |
...
Run the instrument as you go:
    ...
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py score --candidate icon.svg --reference icon-engineC-fe8278-2.png --outdir /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r04 --label "r04 detail"
    python3 /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/skills/create-mac-icon/scripts/fidelity.py gate --candidate /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r04/score.json --baseline /Users/lukerhodes/Dev/fledgeling-plugins/plugins/create-mac-icon/assets/loop-runs/r03/score.json
