...
| 3 | **Review every open PR** with the `code-review` skill, one review per PR number from Step 1. Post the review with `gh pr comment <n>`, apply fixes for real findings, push to the PR branch. | both | 3–8 min/PR |
