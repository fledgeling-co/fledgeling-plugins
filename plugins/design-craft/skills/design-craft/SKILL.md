...
**The ux-craft:ux-craft layer chains in alongside these** (ch. 16): flows and forms load the matching ux-craft reference before building; AI-facing surfaces load its AI-product-UX guidance; every `polish-pass` includes the UX lens.
