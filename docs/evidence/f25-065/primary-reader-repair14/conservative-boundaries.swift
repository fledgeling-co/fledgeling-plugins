...
func directControl() { seedVoid(); read() }
func commentControl() { /* return throw */ seedVoid(); read() }
func stringControl() { let note = "return throw"; seedVoid(); read(); _ = note }
func closureControl() { let closure = { return }; _ = closure; seedVoid(); read() }
func `return`() {}
func escapedKeywordControl() { `return`(); seedVoid(); read() }
directControl(); commentControl(); stringControl(); closureControl(); escapedKeywordControl()
print("final stores=\(stores) reads=\(reads)")
