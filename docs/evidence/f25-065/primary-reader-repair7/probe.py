...
# Material false green: the bound helper's opening brace was consumed before depth analysis.
assert boundaries["readerInsideHelperTrailingClosure"]["cliExit"] == 0
...
receipt = {
    ...
    "blockingFalseGreen": {
        "claim": "A reader inside the bound helper's trailing closure is treated as top-level because the helper match consumed the opening brace.",
        "source": sources["readerInsideHelperTrailingClosure"][0],
        "cliExit": boundaries["readerInsideHelperTrailingClosure"]["cliExit"],
    },
