#!/usr/bin/env python3
"""Repeated distinct additional F25-065 probes against exact repaired implementation 2b186f8."""
...
TARGET = "2b186f8b92c2f87544b3f244289cee15a5bc62d6"
...
assert boundaries["inactiveCompilationBranch"]["cliExit"] == 0
assert boundaries["missingModuleCompilationBranch"]["cliExit"] == 0
...
mutants = [
    ...
    mutation("allow-nested-reader",
             ...
             b"    if False:\n        return False\n"),
    mutation("break-helper-trailing-brace-baseline",
             b"    if depth != minimum_depth:\n        return False\n",
             b"    if depth != 0:\n        return False\n"),
]
...
result = {
    ...
    "blockingFalseGreen": {
        "claim": "A configured reader in an inactive Swift conditional-compilation branch receives observation credit.",
        "source": sources["inactiveCompilationBranch"][0],
        "cliExit": boundaries["inactiveCompilationBranch"]["cliExit"],
        "swiftTypecheckExit": 0,
    },
    "secondaryControlFlowFalseGreen": {
        "claim": "A configured reader under false canImport conditional compilation also receives observation credit.",
        "source": sources["missingModuleCompilationBranch"][0],
        "cliExit": boundaries["missingModuleCompilationBranch"]["cliExit"],
    },
