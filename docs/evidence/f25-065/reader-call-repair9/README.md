...
Correction: the referenced corpus log contains 10 invalid `withRetryStore` bindings and 15 findings, not zero/five. Fresh reviews `a6dc3884` and `9a131e61` caught this; reader-call-repair10 is operative.
