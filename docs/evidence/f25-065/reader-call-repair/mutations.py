...
mutants=[
 ...
 ('skip-helper-execution-context',
  ...
  'False):'),
 ('allow-return-position-helper',
  'if re.search(r"\\b(?:return|throw)\\b", source[:start]):\n        return False',
  'if False:\n        return False'),
 ('narrow-helper-terminal-to-current-statement',
  'if re.search(r"\\b(?:return|throw)\\b", source[:start]):',
  'if re.search(r"\\b(?:return|throw)\\b", re.split(r"[;{}]", source[:start])[-1]):'),
 ('allow-parenthesized-trailing-helper',
